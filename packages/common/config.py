...
class Settings(BaseSettings):
    ...
    intake_service_url: AnyUrl | str = Field(
        default="http://127.0.0.1:8002", validation_alias="INTAKE_SERVICE_URL"
    )
    vision_service_url: AnyUrl | str = Field(
        default="http://127.0.0.1:8003", validation_alias="VISION_SERVICE_URL"
    )
